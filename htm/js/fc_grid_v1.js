      ...
      if(saveCodVideoGrid == ""){
        for(var i=0;i<=FC_MaxImages;i++)
        {
          if(i===0)
          {
            ...
            sHtmlZoom+="<div data-slide-id='zoom' class='zoom-gallery-slide active'><a href="+imgAmpMini+" class='MagicZoom' id='zoom2' data-mobile-options='textClickZoomHint:;zoomMode:off' data-options='hint:off;selectorTrigger:hover;transitionEffect:false;lazyZoom:true'><img width='512' height='543' src="+ imgDetMini +" alt=\""+ fn.getNameProduct() +"\" "+ sLazy +"></a></div>"
